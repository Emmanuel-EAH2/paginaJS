...
function  infoMovie(){
    ...
    for(let i = 0; i < movies.length; i++ ){
        // list =
        document.getElementById('info-movie').innerHTML=  `<h2>${movies[i].title}</h2>`;                                    
        document.getElementById('imagen').innerHTML= `<img src="${movies[i].posterurl}" alt="${movies[i].storyline}">` ;
        document.getElementById('realseDate').innerHTML= `<h3>Release date </h3> <p>${movies[i].releaseDate}</p>`;
        document.getElementById('MainAct').innerHTML= `<h3>Main Actors</h3> <p>${movies[i].actors}</p>`;
        document.getElementById('Rating').innerHTML= `<h3>Rating</h3> <p>${movies[i].ratings}</p>`;
        document.getElementById('genres').innerHTML= `<h3>Genres</h3> <p>${movies[i].genres}</p>`;
    }
    // document.getElementsByClassName('fondo').innerHTML = list;

    function description(){
        document.getElementById('imagen').innerHTML = `<img class="descripcion" src="${movies[i].posterurl}" alt="${movies[i].storyline}">`
    }
    // document.getElementById('').innerHTML= movies;
}